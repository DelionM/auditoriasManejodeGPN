...
// Query para actualizar la fila 13 (Veintiuno) en la tabla auditoria_proceso
...
// Ejecutar consulta
if ($stmt->execute()) {
    echo json_encode(["success" => true, "mensaje" => "✅ Fila Veintiuno actualizada correctamente."]);
} else {

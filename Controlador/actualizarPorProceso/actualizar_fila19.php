...
// Query para actualizar la fila 13 (Diecinueve) en la tabla auditoria_proceso
...
// Ejecutar consulta
if ($stmt->execute()) {
    echo json_encode(["success" => true, "mensaje" => "✅ Fila Diecinueve actualizada correctamente."]);
} else {

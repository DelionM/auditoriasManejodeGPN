<?php
// Desactivar mensajes de error en la salida (solo para producción, en desarrollo puedes dejarlo activo para depurar)
...
// Query para actualizar la fila 1 (Uno) en la tabla auditoria_proceso
...
// Ejecutar consulta
if ($stmt->execute()) {
    echo json_encode(["success" => true, "mensaje" => "✅ Fila Uno actualizada correctamente."]);
} else {

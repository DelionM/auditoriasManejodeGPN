...
// Query para actualizar la fila 13 (Veintitres) en la tabla auditoria_proceso
...
// Ejecutar consulta
if ($stmt->execute()) {
    echo json_encode(["success" => true, "mensaje" => "✅ Fila Veintitres actualizada correctamente."]);
} else {

...
// Capturar datos de $_POST (FormData enviado desde JavaScript)
$id_auditoria = isset($_POST['id']) ? trim($_POST['id']) : '';
$nombreAuditado = isset($_POST['nombreAuditado']) ? trim($_POST['nombreAuditado']) : '';
$nombreSupervisor = isset($_POST['nombreSupervisor']) ? trim($_POST['nombreSupervisor']) : '';
$nombreAuditor = isset($_POST['nombreAuditor']) ? trim($_POST['nombreAuditor']) : '';

// Depuración exhaustiva
$debug_msg = "=== Nueva solicitud ===\n" .
             "Datos recibidos en \$_POST:\n" .
             "id: '" . (isset($_POST['id']) ? $_POST['id'] : 'No recibido') . "'\n" .
             "nombreAuditado: '" . (isset($_POST['nombreAuditado']) ? $_POST['nombreAuditado'] : 'No recibido') . "'\n" .
             "nombreSupervisor: '" . (isset($_POST['nombreSupervisor']) ? $_POST['nombreSupervisor'] : 'No recibido') . "'\n" .
             "nombreAuditor: '" . (isset($_POST['nombreAuditor']) ? $_POST['nombreAuditor'] : 'No recibido') . "'\n" .
             "Después de trim:\n" .
             "id_auditoria: '$id_auditoria' (longitud: " . strlen($id_auditoria) . ")\n" .
             "nombreAuditado: '$nombreAuditado' (longitud: " . strlen($nombreAuditado) . ")\n" .
             "nombreSupervisor: '$nombreSupervisor' (longitud: " . strlen($nombreSupervisor) . ")\n" .
             "nombreAuditor: '$nombreAuditor' (longitud: " . strlen($nombreAuditor) . ")\n" .
             "Contenido completo de \$_POST: " . print_r($_POST, true) . "\n";
